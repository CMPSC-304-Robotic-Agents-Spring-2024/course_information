...
9      | Understanding ROS | <ul><li>[Activity 13: `turtlebot` teleop](https://classroom.github.com/a/7rgBv-KS)</li> <li>Community Engagement Event on March 14th</li><li>[**Project 3: ROS**]()</li></ul> |  Read [ROS Basic Concepts](http://docs.ros.org/en/humble/Concepts/Basic.html).
...
11     | Robot Manipulation and Navigation | <ul><li>Guest lecture on March 26th</li> <li>Activity: Open source ROS project presentations</li><li>[**Project 4: turtlebot**]()</li></ul> | Read Chapters 12 and 14 in the ["Introduction to Autonomous Robots"](https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots).
12     | Learning in robotics | <ul><li>Activity: feature detection</li> <li>QUIZ 4 on April 4th</li><li>Civic Learning Reflection and Action Report</li></ul>| Read Chapter 9 in the ["Introduction to Autonomous Robots"](https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots).
...
14     | Final Projects | <ul><li>[**Project 5: student choice**]()</li><li>Future of robotics presentations</li> <li>QUIZ 5 on April 18th</li></ul> | Literature review
