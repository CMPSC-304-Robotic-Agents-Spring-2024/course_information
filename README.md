...
11     | Robot Manipulation and Navigation | <ul><li>[Activity 14: Guest lecture on March 26th](https://forms.gle/B2nmweLNeav2Y7pm9)</li> <li>Activity: Open source ROS project presentations</li><li>[**Project 4: turtlebot**]()</li></ul> | Read Chapters 12 and 14 in the ["Introduction to Autonomous Robots"](https://github.com/Introduction-to-Autonomous-Robots/Introduction-to-Autonomous-Robots).
