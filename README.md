...
9      | Understanding ROS | <ul><li>Activity: Getting to know `turtlebot`</li> <li>Community Engagement Event on March 14th</li><li>[**Project 3: ROS**]()</li></ul> |  Read [ROS Basic Concepts](http://docs.ros.org/en/humble/Concepts/Basic.html).
